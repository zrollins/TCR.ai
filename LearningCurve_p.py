...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  8 10:19:16 2021
...
svm = DecisionTreeRegressor(max_depth=6,
              max_features='auto',
              max_leaf_nodes =3,
              splitter='random')
...
axes[0].set_title("Learning Curve: (Primary Feature Decision Tree)")
...
axes[1].set_title("Scalability of the Model: (Primary Feature Decision Tree)")
plt.savefig('/Users/zrollins/Documents/Documents/DMF5_MART1/rndm/AI/pfeatures/learningcurve.png', dpi=300, bbox_inches='tight')