...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  8 10:37:39 2021
...
predicted = cross_val_predict(svm, X, y, cv=9)
r2=r2_score(y,predicted)
print(r2)

fig, ax = plt.subplots()
ax.scatter(y, predicted, c='red',edgecolors=(0, 0, 0))
ax.plot([y.min(), y.max()], [y.min(), y.max()], 'k--', lw=4)
ax.set_xlabel('Measured')
ax.set_ylabel('Predicted')
ax.set_title('Quaternary Feature SVM Predictions')
plt.savefig('/Users/zrollins/Documents/Documents/DMF5_MART1/rndm/AI/qfeatures/r2.png', dpi=300, bbox_inches='tight')